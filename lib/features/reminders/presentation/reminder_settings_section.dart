  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Column(
      ...
      children: [
        ...
        _switchRow(
          context: context,
          title: context.l10n.smartNutritionRemindersTitle,
          subtitle:
              '${context.l10n.dailyReminderAtLabel} ${_formatTime(context, settings.smartNutritionTime)}',
          value: settings.smartNutritionEnabled,
          onChanged: controller.toggleSmartNutrition,
        ),
        _timeAction(
          context: context,
          label: context.l10n.setSmartNutritionTimeLabel,
