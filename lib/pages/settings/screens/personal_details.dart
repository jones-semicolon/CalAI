                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Text(context.l10n.goalWeightLabel, style: TextStyle(color: Colors.grey, fontSize: 12)),
                          ...
                          ElevatedButton(
                            ...
                            child: Text(context.l10n.changeGoalLabel, style: TextStyle(color: Colors.white, fontSize: 14)),
                          ),
                        ],
                      ),
                    ),
                  ...
                  _buildCard(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildDivider(),
                        _buildListTile(context.l10n.genderLabel, genderStr ?? context.l10n.notSetLabel,
